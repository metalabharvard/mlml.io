...
func main() {
  ...
  for _, element := range responseObject {
    ...
    element.Categories = utils.CleanTypes(element.Types)

    // Tags used for Open Graph
    element.Tags = utils.CreateTags(element.Keywords, element.Types)

    // Keyword string for page header
    element.Keyword = utils.CreateKeywordString(element.Tags)

    // This was generated by Strapi and can be deleted
    element.Keywords = nil
    element.Types = nil
